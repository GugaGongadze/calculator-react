  ...
  render() {
    return (
      <div className="special-operators">
        <button className="special-button" onClick={this.onAllClearClick}>
          AC
        </button>
        <button className="special-button" onClick={this.onInvertClick}>
          +/-
        </button>
        <button className="special-button" onClick={this.onPercentClick}>
          %
        </button>
      </div>
    );
